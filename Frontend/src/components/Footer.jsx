      ...
      <div className="footer-inner">
        <div className="footer-grid">
          ...
          <div className="footer-col brand-col">
            <Link to="/" className="brand-nav footer-brand">
            ...
            <p>
              Bringing the vibrant sparks of Sivakasi to your celebrations since 2010. 
              Every firework is a journey through tradition and joy.
            </p>
            <div className="social-icons">
              ...
              <a href="#tw" className="social-icon" aria-label="Twitter">
        ...
        <div className="footer-bottom">
          <p>© 2026 Cracker Kingdom. All rights reserved. Made with ❤️ in India</p>
        </div>
      </div>
    </footer>
  );
